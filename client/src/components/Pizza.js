    ...
    return (
       ...
       <div className="flex-container">
           ...
           <div className='w-100 m-1'>
               ...
               <p>Quantity</p>
               <select className='form-control'value={quantity} onChanges={(e)=>{setquantity(e.target.value)}}>
...
<div className='m-1 w-100'>
  ...
  <Modal.Body>
    <img src={pizza.image} style={{height:'300px !important',width:'300px !important'}}/>
  </Modal.Body>
